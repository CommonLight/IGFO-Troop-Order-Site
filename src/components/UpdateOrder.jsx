...
const UpdateOrder = () => {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        axios.patch(`http://localhost:8000/api/troops/update/${id}`, troopOrder)
    ...
    style={{
        ...
        <form onSubmit = {submitHandler} style={{textAlign:"right"}}>
            <div className='imageDisplay' style={{display:"flex"}}>
                ...
                {updateOrder && troopOrder.trooperType && troopOrder.trooperType !== "Choose an option" && (
                ...
                <div style={{
                    ...
                    <div style={{paddingTop:"40px"}}>
                        ...
                        <p style={{color:"teal", fontSize:"10pt", marginBottom:"-5px"}}>Previous Selection:
                        <span style={{fontSize:"14pt"}}> {updateOrder.trooperType}</span></p>
                        ...
                        <div style={{textAlign:"center"}}>
                        <p style={{color:"teal", fontSize:"10pt", marginBottom:"-5px"}}>Previous Selection:
                        <span style={{fontSize:"14pt"}}> {updateOrder.trooperWeapon}</span></p>
                        ...
                        <div style={{textAlign:"center"}}>
                        <p style={{color:"teal", fontSize:"10pt", marginBottom:"-5px"}}>Previous Selection:
                        <span style={{fontSize:"14pt"}}> {updateOrder.trooperArmor}</span></p>
                        ...
                        <div style={{textAlign:"center"}}>
                        <p style={{color:"teal", fontSize:"10pt", marginBottom:"-5px"}}>Previous Selection:
                        <span style={{fontSize:"14pt"}}> {updateOrder.trooperAmount}</span></p>
                ...
                <div style={{
                    ...
                    <div style={{paddingTop:"40px"}}>
                        ...
                        <p onChange={changeHandler}>
                            ...
                            Subtotal: </em>${
                            // subTotal === 0 ? 
                            // troopOrder.subTotal.toLocaleString(undefined, {
                            // minimumFractionDigits: 2,
                            // maximumFractionDigits: 2}) : 
                            formattedSubtotal.toLocaleString(undefined, {
                            minimumFractionDigits: 2, 
                            maximumFractionDigits: 2,})}
                            </p>
                            
                            <p style={{color:"teal", fontSize:"10pt", marginTop:"-15px"}}>Prior Subtotal: ${updateOrder.subTotal.toLocaleString(undefined, {
                        ...
                        <p onChange={changeHandler}>
                            ...
                            Imperial Tax: </em>${
                            // taxAmount === 0 ? 
                            // troopOrder.taxAmount.toLocaleString(undefined, {
                            // minimumFractionDigits: 2,
                            // maximumFractionDigits: 2}) :
                            ...
                            <p style={{color:"teal", fontSize:"10pt", marginTop:"-15px"}}>Prior Imperial Tax: ${updateOrder.taxAmount.toLocaleString(undefined, {
                            minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
                        ...
                        <p onChange={changeHandler}>
                            ...
                            Grand Total: </em>${
                            // grandTotal === 0 ? 
                            // troopOrder.grandTotal.toLocaleString(undefined, {
                            // minimumFractionDigits: 2,
                            // maximumFractionDigits: 2}) : 
                            ...
                            <p style={{color:"teal", fontSize:"10pt", marginTop:"-15px"}}>
                            Previous Grand Total: ${updateOrder.grandTotal.toLocaleString(undefined, {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2})}
                            </p>
                    ...
                    {/* <Link to={'/enter'}>
                    <Button style={{margin:"10px", cursor:"default", fontFamily:"Audiowide"}} variant="dark">BACK TO MAIN
                    </Button></Link> */}
